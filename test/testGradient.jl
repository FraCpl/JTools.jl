...
@show x = gradientDescent(f, x0; η=0.1, method=:rmsprop, verbose=false, maxIter=1000)
@show x = gradientDescent(f, x0; η=0.1, method=:adam, verbose=false, maxIter=1000)
@show x = gradientDescent(f, x0; η=0.1, method=:momentum, verbose=false, maxIter=1000)
