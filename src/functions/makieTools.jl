function theme_fra(spinevis=true; light=false)
    ...
    Theme(;
        ...
        Legend=(framevisible=true, backgroundcolor=bg, framewidth=3.0, framecolor=bg, padding=(0, 0, 0, 0)),
        Axis3=(
            xgridcolor=gridcol,
            ygridcolor=gridcol,
            zgridcolor=gridcol,
...
function plotPlanet!(ax, texture, radius=1.0, pos_I=zeros(3), R_IP=I; n=256, kwargs...)
    ...
    surface!(ax, getindex.(posBody_I, 1), getindex.(posBody_I, 2), getindex.(posBody_I, 3); color=load(texture), shading=NoShading, kwargs...)
end
...
function plotSphere!(ax, radius=1.0, pos_I=zeros(3), n=256; kwargs...)
    ...
    @show kwargs
    surface!(ax, getindex.(posBody_I, 1), getindex.(posBody_I, 2), getindex.(posBody_I, 3); shading=NoShading)#, kwargs...)
end
